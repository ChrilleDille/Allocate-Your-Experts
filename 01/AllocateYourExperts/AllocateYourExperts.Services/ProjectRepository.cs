...
namespace AllocateYourExperts.Services
{
    public class ProjectRepository : IProjectRepository
    {
        ...
        public ProjectTeam GetProjectTeamMap(Guid projectId)
        {
            var projectTeam = new ProjectTeam();
            projectTeam.Project = this.GetProject(projectId);
            projectTeam.Members = new List<TeamMember>();
            foreach (var pe in 
                this.GetProjectIncludedExpertsAndRoles(projectId)
                .ProjectExperts)
            {
                projectTeam.Members.Add(new TeamMember { 
                Expert = pe.Expert,
                Role = pe.Role
                });
            }
