...
namespace AllocateYourExperts.API.Controllers
{
    ...
    public class ProjectTeamController : ControllerBase
    {
        ...
        public ActionResult<ProjectTeam> GetProjectTeam(Guid projectId)
        {
            ...
            var projectTeam = projectRepository.GetProjectTeamMap(projectId);
             ...
             Guid projectId, Guid expertId)
        {
            ...
            var teamMember = projectRepository.GetProjectTeamMap(projectId)
            ...
            TeamMember member)
        {
            ...
            var teamMemberToReturn = projectRepository.GetProjectTeamMap(project.Id)
